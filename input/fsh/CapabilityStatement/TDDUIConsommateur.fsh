...
* publisher = "ANS"
* description = "Le rôle du consommateur est de recueillir les données du Dossier Usager Informatisé. \n  Il peut recevoir un unique dossier ou un ensemble de dossiers, ainsi que des mises à jour de dossiers. \n Il correspond à un logiciel DUI ou un SI tiers."
* kind = #requirements
* fhirVersion = #4.0.1
...
* rest.mode = #client
* rest.documentation = "Réception de données exportées depuis un logiciel DUI (flux 1 et 2). \n Réception de mise à jour de données exportées depuis un logiciel DUI (flux 3)"
